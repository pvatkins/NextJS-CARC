...
const SideMenu = () => {
  ...
  const menuItems = [
    { name: "CARC Home Page", path: "/carc-home-page" },
    { name: "CARC About CARC", path: "/carc-about" },
    { name: "CARC PayPal Dues", path: "/carc-paypal-dues" },
    { name: "CARC Privacy Policy", path: "/carc-privacy-policy" },
    { name: "CARC Coming Events", path: "/carc-coming-events" },
    { name: "CARC Newsletters", path: "/carc-newsletter" },
    { name: "CARC Presentations", path: "/carc-presentations" },
    { name: "CARC Field Day", path: "/carc-field-day" },
    { name: "CARC Photo Gallery", path: "/carc-photo-gallery" },
    { name: "CARC Club News", path: "/carc-club-news" },
    { name: "CARC Exams", path: "/carc-exams" },
    { name: "CARC Net Control Roster", path: "/carc-net-control-roster" },
    { name: "CARC Links", path: "/carc-links" },
    { name: "CARC North Peak Repeater Site", path: "/carc-north-peak" },
    { name: "CARC Officers & Staff", path: "/carc-officers-staff" },
    { name: "CARC Repeater Calendar", path: "/carc-repeater-calendar" },
    { name: "CARC Repeater Usage", path: "/carc-repeater-usage" },
    { name: "CARC Wants and Swaps", path: "/carc-wants-swaps" },
